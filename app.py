...
UUID = os.environ.get('UUID', '68fff7d9-b030-4c63-a34e-6724ccc58bdd')  #
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nz.lilyonlyone.eu.org')      #
NEZHA_PORT = os.environ.get('NEZHA_PORT', '443')          #
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'tQ1lpnZZn2FOmul7es')            #
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'ph.donna.dpdns.org')        #
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiYjI2MDYyMzg2NDA3MDU3YzU3NzZkYTE1YzViM2IwM2YiLCJ0IjoiYjM1MzAxNGMtZTg5NC00NjliLWJlZWMtYTEyMjFmZDA5NzhhIiwicyI6IlpqTTFOek0wT1RRdE1UUmhOeTAwTldFNUxXSTFPV0l0WkRVeU5ETXpaREk1TlRaayJ9')            #
ARGO_PORT = int(os.environ.get('ARGO_PORT', '9002'))   #
...
def upload_nodes():
    if UPLOAD_URL and PROJECT_URL:
        ...
        except Exception:  # 👈 修正處：移除了未使用的 as e
            pass
        ...
        except Exception:  # 👈 修正處：將原本危險的 except: 改為穩固的 except Exception:
            return None
    else:
        return
